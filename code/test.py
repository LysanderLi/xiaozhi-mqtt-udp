...
# udp_socket.connect(("101.37.104.185", "43792"))
# udp_socket.settimeout(1)  # 设置0.1秒超时
# if udp_socket.getsocketsta() == 4:
...
# 建立连接
sock.connect(("101.37.104.185", "44213"))
# 向服务端发送消息
ret=sock.send('161646131661651646164616616')
print('send %d bytes' % ret)
ret = sock.getsocketsta()
print("socket state",ret)
#接收服务端消息
data=sock.recv(256)
